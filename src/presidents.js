...
function getDemocraticPresidents(presidentsArr) {
  const dems = presidentsArr.filter((president) => {
...
function sortPresidentsByBirthYear(presidentsArr) {
  const presidentBirth = presidentsArr.sort((president1, president2) => {
    if (president1.birthYear < president2.birthYear) return -1;
    if (president1.birthYear > president2.birthYear) return 1;
    if ((president1.birthYear = president2.birthYear)) return 0;
  });
  return presidentBirth;
}
